...
const SheetMusicDisplay: React.FC<SheetMusicDisplayProps> = ({ midiNumber }) => {
      ...
      <>
        ...
        <div
          ...
          style={{
            ...
            left: `${xOffset + accidentalOffset + (midiNumber >= 71 ? -(noteHeadSize / 2 - stemWidth / 2) : (noteHeadSize / 2 - stemWidth / 2))}px`, // Shift stem to the right
          }}
        ></div>
        {/* Ledger Lines */}
